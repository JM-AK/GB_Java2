...
public class MainClass {
    ...
    public static class FirstTest implements Runnable {
        ...
        public void run() {
            ...
            adjustArray(arr);
            printTestTime((System.currentTimeMillis() - startTime) / 1000);
    ...
    public static class SecondTest extends FirstTest {
        ...
        public void run() {
            ...
            Thread adj1 = new Thread(() -> adjustArray(arr1));
            Thread adj2 = new Thread(() -> adjustArray(arr2));
